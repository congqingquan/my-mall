...
//@RestController
public class SentinelBaseOriginController {
    ...
    @SentinelResource(value = RESOURCE2_NAME,
            blockHandler = "handleSentinelException", blockHandlerClass = SentinelBaseOriginController.class,
            fallback = "handleBusinessException", fallbackClass = SentinelBaseOriginController.class
    )
